...
namespace sakila.services.Db
{
	public class SakilaDbContext : BaseDbContext<SakilaDbContext>
	{
		private readonly IOptions<ApplicationSettings> _applicationSetting;
		public SakilaDbContext(IOptions<ApplicationSettings> applicationSetting)
		{
		...
		protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
		{
			...
			{
				optionsBuilder.UseSqlServer(_applicationSetting.Value.ConnectionString);
			}
		}
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			{
				entity.Property(e => e.MenuActive).HasDefaultValueSql("((0))");
				...
				entity.HasOne(d => d.MenuParent)
					...
					.HasConstraintName("FK__Menu__MenuParent__17F790F9");
			});
